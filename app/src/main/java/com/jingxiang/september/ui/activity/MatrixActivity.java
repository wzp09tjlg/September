...
import com.jingxiang.september.ui.widget.MatrixImageView;
import com.jingxiang.september.util.LogUtil;

/**
 * Created by wu on 2016/10/26.
 */
public class MatrixActivity extends BaseFragmentActivity {
    /** View */
    private MatrixImageView mTestMatrixImageView;
    /** Data */
    ...
    private void initViews(){
        mContext = this;
        mTestMatrixImageView = new MatrixImageView(mContext);
    ...
    private void showMatrixEveryValue(Matrix matrix){
        ...
        for (int i = 0; i <3; i++) {
            ...
            for (int j = 0; j < 3; j++) {
                ...
                LogUtil.e("第"+(i+1)+"行的第"+(j+1)+"列的值为"+valueString);
            }
        }
    }
}
